...
document.querySelectorAll('input[data-id]').forEach(function (element) {
  ...
  element.onclick = function (e) {
    if (e.target.checked) {
      ...
      var url = '/edit/' + element.dataset.id;
...
document.querySelectorAll('.filter-group').forEach(function (element) {
...
function filter() {
  ...
  var fb = new FormData();
  document.querySelectorAll('.filter-group').forEach(function (element) {
    if (element.checked) fb.append(element.name, element.value);
  });
  ...
  xhr.onload = function () {
    ...
    var table = res.getElementById('students_table').innerHTML;
